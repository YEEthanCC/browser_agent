...
def get_azure_client(env_path: Optional[Path] = None) -> AIProjectClient:
    """
...
def get_azure_connection(env_path: Optional[Path] = None) -> AzureAIConnection:
    """
    ...
    """
    return AzureAIConnection(env_path)
